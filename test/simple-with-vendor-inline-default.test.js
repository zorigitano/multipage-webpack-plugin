...
const simpleConfig = require('../examples/simple-with-vendor-inline-default/webpack.config.js');
const simpleExamplePath = path.resolve(__dirname, '../examples/simple-with-vendor-inline-default');
